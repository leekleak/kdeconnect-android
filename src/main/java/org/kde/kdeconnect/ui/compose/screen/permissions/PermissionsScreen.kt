package org.kde.kdeconnect.ui.compose.screen.permissions
...
fun PermissionsScreen(
    ...
    HazeScaffold(backAction = BackAction.None) {
        Icon(
            ...
            painter = painterResource(R.drawable.ic_kde_24dp),
        ...
        Text(
            modifier = Modifier
                .padding(8.dp)
                .align(Alignment.CenterHorizontally),
            text = stringResource(R.string.location_permission_needed_title),
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
            PermissionCard(
                ...
                description = stringResource(R.string.ensures_the_app_can_run_in_the_background),
        ...
        PermissionCard(
            ...
            description = stringResource(R.string.ensures_the_app_is_able_to_process_incoming_commands),
            icon = R.drawable.flip_to_front,
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.CINNAMON_BUN) {
            PermissionCard(
                ...
                description = stringResource(R.string.required_to_find_other_devices),
...
private fun PermissionCard(
    ...
    Row (
        ...
        IconPreference(
            title = stringResource(R.string.grant),
