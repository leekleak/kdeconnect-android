...
@Serializable
data class DeviceSettingsKey(val deviceId: String) : KdeConnectKey
@Serializable
data class DeviceShortcutSettingsKey(val deviceId: String) : KdeConnectKey
@Serializable
...
@Serializable
data class ShareFilesKey(val deviceId: String) : KdeConnectKey
