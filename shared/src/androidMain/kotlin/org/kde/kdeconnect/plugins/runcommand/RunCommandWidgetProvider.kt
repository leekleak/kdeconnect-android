...
internal suspend fun updateAppWidget(
    ...
    val views = RemoteViews(context.packageName, R.layout.widget_remotecommandplugin)
    ...
    if (device == null) {
        ...
        views.setTextViewText(R.id.widget_title_text, getString(Res.string.kde_connect))
        ...
        if (device.isReachable) {
            ...
            views.setTextViewText(R.id.widget_error_text, getString(Res.string.runcommand_notreachable))
        }
    }
