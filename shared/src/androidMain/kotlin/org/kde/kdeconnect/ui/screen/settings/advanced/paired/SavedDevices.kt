...
import org.kde.kdeconnect.generated.resources.are_you_sure_you_want_to_unpair_this_device
...
fun SavedDevices(
            ...
            LazyColumn(
                ...
                items(uiState.saved, { it.deviceInfo.id }) { device ->
                    ...
                    DeviceCard(
                        device = device,
                        navigator = null,
                        actionIcon = painterResource(Res.drawable.link_off),
                        actionDescription = stringResource(Res.string.device_menu_unpair),
    ...
    if (deviceToUnpair != null) {
        FancyDialog(
            title = stringResource(Res.string.device_menu_unpair),
            icon = painterResource(Res.drawable.link_off),
            content = {
                Text(
                    text = stringResource(Res.string.are_you_sure_you_want_to_unpair_this_device),
            ...
            actionButton = {
                TextButton(onClick = {
                    ...
                    Text(stringResource(Res.string.device_menu_unpair))
                }
            },
