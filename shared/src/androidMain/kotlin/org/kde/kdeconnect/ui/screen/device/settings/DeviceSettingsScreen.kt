...
import org.kde.kdeconnect.generated.resources.action_key
...
import org.kde.kdeconnect.generated.resources.contacts
import org.kde.kdeconnect.generated.resources.device_menu_unpair
import org.kde.kdeconnect.generated.resources.global_settings
import org.kde.kdeconnect.generated.resources.link_off
...
import org.kde.kdeconnect.generated.resources.query_stats
import org.kde.kdeconnect.generated.resources.receive
import org.kde.kdeconnect.generated.resources.send
import org.kde.kdeconnect.generated.resources.shortcut_settings
...
fun DeviceSettingsScreen(
    ...
    HazeScaffold(
        ...
        actions = {
            IconButton(viewModel::unpair) { // Todo: Confirmation dialog would be nice
                Icon(
                    ...
                    contentDescription = stringResource(Res.string.device_menu_unpair),
                )
            }
        }
    ) {
        CategoryTitleTextSmall(stringResource(Res.string.notifications))
        Row(horizontalArrangement = Arrangement.spacedBy(8.dp)) {
            NotificationTogglePreference(
                modifier = Modifier.weight(1f),
                title = stringResource(Res.string.send),
                icon = painterResource(Res.drawable.arrow_upward),
                value = notificationSend == true,
                onValueChanged = { onPluginToggled(NotificationsPluginInfo.pluginKey, it) }
            )
            NotificationTogglePreference(
                modifier = Modifier.weight(1f),
                title = stringResource(Res.string.receive),
                icon = painterResource(Res.drawable.arrow_downward),
        ...
        SwitchPreference(
            ...
            icon = painterResource(Res.drawable.assignment),
        ...
        SwitchPreference(
            ...
            icon = painterResource(Res.drawable.contacts),
            value = contacts == true,
        ...
        SwitchPreference(
            ...
            icon = painterResource(Res.drawable.query_stats),
            value = connectivity == true,
            onValueChanged = { onPluginToggled(ConnectivityReportPluginInfo.pluginKey, it) }
        )
        NavigatePreference(
            title = stringResource(Res.string.shortcut_settings),
            icon = painterResource(Res.drawable.action_key),
            onClick = { navigator.goTo(DeviceShortcutSettingsKey(deviceId)) }
        )

        CategoryTitleTextSmall(stringResource(Res.string.global_settings))
        NavigatePreference(
