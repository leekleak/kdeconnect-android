...
import org.kde.kdeconnect.generated.resources.save
import org.kde.kdeconnect.generated.resources.sftp_action_mode_menu_delete
import org.kde.kdeconnect.generated.resources.sftp_preference_add_storage_location_title
import org.kde.kdeconnect.generated.resources.sftp_preference_configured_storage_locations
import org.kde.kdeconnect.generated.resources.sftp_preference_edit_storage_location
import org.kde.kdeconnect.generated.resources.sftp_storage_preference_display_name
...
fun SftpSettingsScreen(
    ...
    HazeScaffold(
        title = stringResource(Res.string.pref_plugin_sftp),
        ...
        LazyColumn(
            ...
            item {
                CategoryTitleTextSmall(text = stringResource(Res.string.sftp_preference_configured_storage_locations))
            }
            ...
            item {
                Preference(
                    title = stringResource(Res.string.sftp_preference_add_storage_location_title),
...
fun EditStorageDialog(
    ...
    Dialog(onDismissRequest = onDismiss) {
        Column(
            ...
            Text(
                text = stringResource(Res.string.sftp_preference_edit_storage_location),
            ...
            OutlinedTextField(
                ...
                label = { Text(stringResource(Res.string.sftp_storage_preference_display_name)) },
                isError = error != null,
            ...
            Row(
                ...
                TextButton(onClick = onDelete) {
                    Text(
                        text = stringResource(Res.string.sftp_action_mode_menu_delete),
